...
type (
	...
	TranscriptRepoI interface {
		...
		Delete(ctx context.Context, id int) error
		StartTranscripts(ctx context.Context, id int) error
	}
	...
	AudioSegmentRepoI interface {
		...
		DatasetViewer(ctx context.Context, req *entity.Filter, user_id string, report, ruBool, number bool) (*entity.DatasetViewerListResponse, error)
